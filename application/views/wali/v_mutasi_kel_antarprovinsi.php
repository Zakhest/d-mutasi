    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Mutasi Keluar Antarprovinsi</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                <li class="breadcrumb-item active">Data Mutasi Keluar Antarprovinsi </li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
          ...
          <div class="card">
                <div class="card-header">
                  <h3 class="card-title">List Data Mutasi Keluar Antarprovinsi</h3>
...
<div class="modal fade" id="addModal">
    ...
    <input type="hidden" name="submenu" value="antarprovinsi">
    <input type="hidden" required name="jenis_mutasi" value="keluar">
   <input type="hidden" name="no_telp" value="<?php echo $no_telp?>">
    <input type="hidden" required name="subkategori" value="antarprovinsi">
...
<div class="modal fade" id="editModal">
    ...
    <input type="hidden" id="submenu" required name="submenu" value="antarprovinsi">
    <input type="hidden" id="subkategori" required name="subkategori" value="antarprovinsi">
                              </div>
                              <div class="form-group">
    <label>Surat Permohonan Pindah dari Orang Tua</label>

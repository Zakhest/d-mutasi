    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Mutasi Keluar Antarkota</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                <li class="breadcrumb-item active">Data Mutasi Keluar Antarkota </li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
          ...
          <div class="card">
                <div class="card-header">
                  <h3 class="card-title">List Data Mutasi Keluar Antarkota</h3>
...
function printdata(file) {
        var url = "<?=base_url('assets/surat/')?>"+file;
...
<div class="modal fade" id="editModal">
    ...
    <input type="hidden" id="submenu" required name="submenu" value="antarkota">
    <input type="hidden" id="subkategori" required name="subkategori" value="antarkota">
                              </div>
                              <div class="form-group">
    <label>Surat Permohonan Pindah dari Orang Tua</label>

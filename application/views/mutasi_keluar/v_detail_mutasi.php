    ...
    <link rel="stylesheet" href="<?=base_url()?>assets/admin/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Detail Data Mutasi</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form>
                <div class="card-body">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" readonly value="<?php echo $detail['tgl_disahkan']?>" class="form-control" id="exampleInputPassword1" placeholder="Tanggal Surat Kosong" >
                  </div>
                   <div class="form-group">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" readonly value="<?php echo $detail['ttl']?>" class="form-control" id="exampleInputPassword1" placeholder="Tempat Tanggal Lahir Kosong">
                  </div>

                   <div class="form-group">
                    <label for="exampleInputPassword1">NIS/NISN</label>
                    <input type="text" readonly value="<?php echo $detail['nisn_nis']?>" class="form-control" id="exampleInputPassword1" placeholder="NIS/NISN Kosong">
                  </div>
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" readonly value="<?php echo $detail['sekolah_asal']?>" class="form-control" id="exampleInputPassword1" placeholder="Sekolah Asal Kosong">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Alamat Sekolah Asal</label>
                    <input type="text" readonly value="<?php echo $detail['alamat_sekolah_asal']?>" class="form-control" id="exampleInputPassword1" placeholder="Alamat Sekolah Asal Kosong">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Sekolah Tujuan</label>
                    <input type="text" readonly value="<?php echo $detail['sekolah_tujuan']?>" class="form-control" id="exampleInputPassword1" placeholder="Sekolah Tujuan kosong">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Kota/ Kab</label>
                    <input type="text" readonly value="<?php echo $detail['kota_kab']?>" class="form-control" id="exampleInputPassword1" placeholder="Kota/Kab kosong">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Provinsi</label>
                    <input type="text" readonly value="<?php echo $detail['provinsi']?>" class="form-control" id="exampleInputPassword1" placeholder="Provinsi kosong">
                  </div>
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    <label for="exampleInputPassword1">Sekertaris</label>
                    <input type="text" readonly value="<?php echo $detail['sekertaris']?>" class="form-control" id="exampleInputPassword1" placeholder="Nama Sekertaris kosong">
                  </div>
                   <div class="form-group">
                    <label for="exampleInputPassword1">NIP</label>
                    <input type="text" readonly value="<?php echo $detail['nip']?>" class="form-control" id="exampleInputPassword1" placeholder="NIP Kosong">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Jabatan</label>
                    <input type="text" readonly value="<?php echo $detail['jabatan']?>" class="form-control" id="exampleInputPassword1" placeholder="Jabatan Kosong">
                  </div>
...
function klik() {
 ...
 window.open("<?=site_url('Mutasi/print_mutasi/'.$detail['no'].'/print')?>",height="700", width="500", scrollbars="yes");

...
<div class="modal fade" id="addModal">
    ...
    <input type="hidden" required name="jenis_mutasi" value="keluar_negeri">
    <input type="hidden" name="no_telp" value="<?php echo $no_telp?>">
    <input type="hidden" required name="subkategori" value="ln">
...
<div class="modal fade" id="editModal">
    ...
    <input type="hidden" id="jenis_mutasi" required name="jenis_mutasi" value="keluar_negeri">
    <input type="hidden" id="submenu" required name="submenu" value="index">
    <input type="hidden" id="subkategori" required name="subkategori" value="ln">
                              </div>
                              <div class="form-group">
    <label>Surat Permohonan Pindah dari Orang Tua</label>

    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Mutasi Keluar Antarsekolah</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                <li class="breadcrumb-item active">Data Mutasi Keluar Antarsekolah </li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
          ...
          <div class="card">
                <div class="card-header">
                  <h3 class="card-title">List Data Mutasi Keluar Antarsekolah</h3>
...
<?php endif; ?>
   ...
   <button class="btn btn-info" onclick="printdata('<?php echo $m->surat_hasil_mutasi ?>')">
...
function printdata(file) {
        var url = "<?=base_url('assets/uploads/')?>"+file;
...
<div class="modal fade" id="addModal">
    ...
    <input type="hidden" required name="jenis_mutasi" value="keluar">
    <input type="hidden" name="no_telp" value="<?php echo $no_telp?>">

    <input type="hidden" required name="subkategori" value="antarsekolah">
...
<div class="modal fade" id="editModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
          <form method="post" action="<?=base_url('Wali/EditData/')?>" enctype="multipart/form-data">
    ...
    <input type="text" id="nama_siswa" required name="nama_siswa" class="form-control" placeholder="Masukan nama siswa">
                              ...
                              <div class="form-group">
    <label>Nama Wali</label>
    <input type="text" id="namawali" required name="nama_wali" class="form-control" placeholder="Masukan nama wali">
    <input type="hidden" id="jenis_mutasi" required name="jenis_mutasi" value="keluar">
    <input type="hidden" id="submenu" required name="submenu" value="index">
    <input type="hidden" id="subkategori" required name="subkategori" value="antarsekolah">
                              </div>
                              <div class="form-group">
    <label>Surat Permohonan Pindah dari Orang Tua</label>
...
<script>
    const statuses = ['Pending', 'Verifikasi', 'Disetujui', 'Selesai'];
    const rejectionMessage = document.getElementById('rejected-message');
